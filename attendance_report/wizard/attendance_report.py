...
class DeterminationPeopleReportWizard(models.TransientModel):
    ...
    def check_report(self):
        ...
        return self.env.ref('attendance_report.action_attendance_report_pdf').report_action(self, data=data, config=False)
