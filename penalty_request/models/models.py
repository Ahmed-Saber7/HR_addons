...
class PenaltyRequest(models.Model):
    ...
    contract_id = fields.Many2one(comodel_name="hr.contract", string="", required=False, related="employee_id.contract_id")
    ...
    def generate_payment_date(self):
        ...
        if self.penalty_type == 'days':
            if not self.employee_id.contract_id:
                raise ValidationError("Sorry.. This Employee Dont Have Contract, you can choose Penalty type amount, or create contract for this employee")
            else:
